...
export type AccountsQuery = { __typename?: 'Query', accounts: Array<{ __typename?: 'AccountResponse', id: string, name: string, type: AccountType, subType: AccountSubType, balance: any, balanceLastUpdated?: any | null, currency: CurrencyCode, institutionName?: string | null, source: AccountSource, status: Status, startingBalance: any, closedAt?: any | null, externalId?: string | null, bankConnectionId?: string | null, createdAt: any, updatedAt: any, workspaceId: string }> };
...
export type BankConnectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type BankConnectionsQuery = { __typename?: 'Query', bankConnections: Array<{ __typename?: 'BankConnectionResponse', id: string, institutionName?: string | null, status: Status, lastSyncedAt?: any | null }> };

export type SyncTransactionsMutationVariables = Exact<{
  bankConnectionId: Scalars['ID']['input'];
}>;


export type SyncTransactionsMutation = { __typename?: 'Mutation', syncTransactions?: { __typename?: 'SyncResult', transactionsAdded: number, transactionsModified: number, transactionsRemoved: number, accountsSynced: number } | null };
...
export type LinkBankMutationVariables = Exact<{
  input: LinkBankInput;
}>;


export type LinkBankMutation = { __typename?: 'Mutation', linkBank?: { __typename?: 'BankConnectionResponse', id: string, institutionName?: string | null, status: Status } | null };

export type SyncTransactionsAfterLinkMutationVariables = Exact<{
  bankConnectionId: Scalars['ID']['input'];
}>;


export type SyncTransactionsAfterLinkMutation = { __typename?: 'Mutation', syncTransactions?: { __typename?: 'SyncResult', transactionsAdded: number, accountsSynced: number } | null };
...
export const BankConnectionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"BankConnections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bankConnections"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"institutionName"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"lastSyncedAt"}}]}}]}}]} as unknown as DocumentNode<BankConnectionsQuery, BankConnectionsQueryVariables>;
export const SyncTransactionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SyncTransactions"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"bankConnectionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"syncTransactions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"bankConnectionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"bankConnectionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transactionsAdded"}},{"kind":"Field","name":{"kind":"Name","value":"transactionsModified"}},{"kind":"Field","name":{"kind":"Name","value":"transactionsRemoved"}},{"kind":"Field","name":{"kind":"Name","value":"accountsSynced"}}]}}]}}]} as unknown as DocumentNode<SyncTransactionsMutation, SyncTransactionsMutationVariables>;
...
export const LinkBankDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"LinkBank"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"LinkBankInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"linkBank"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"institutionName"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<LinkBankMutation, LinkBankMutationVariables>;
export const SyncTransactionsAfterLinkDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SyncTransactionsAfterLink"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"bankConnectionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"syncTransactions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"bankConnectionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"bankConnectionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transactionsAdded"}},{"kind":"Field","name":{"kind":"Name","value":"accountsSynced"}}]}}]}}]} as unknown as DocumentNode<SyncTransactionsAfterLinkMutation, SyncTransactionsAfterLinkMutationVariables>;
